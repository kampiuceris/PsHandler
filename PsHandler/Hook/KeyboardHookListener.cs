...
namespace PsHandler.Hook
{
    ...
    public class KeyboardHookListener : BaseHookListener
    {
        ...
        {
            return IsGlobal ? GlobalHooker.WH_KEYBOARD_LL : AppHooker.WH_KEYBOARD;
        }
        ...
        {
            return (System.Windows.Input.Keyboard.Modifiers & System.Windows.Input.ModifierKeys.Alt) == System.Windows.Input.ModifierKeys.Alt;
        }
        ...
        public List<CallbackKeyCombination> KeyDownMethods = new List<CallbackKeyCombination>();
        public List<CallbackKeyCombination> KeyUpMethods = new List<CallbackKeyCombination>();
        ...
        {
            KeyCombination keyCombination = new KeyCombination(System.Windows.Input.KeyInterop.KeyFromVirtualKey(keyEventArgs.KeyValue), IsCtrlDown(), IsAltDown(), IsShiftDown());
            foreach (CallbackKeyCombination method in KeyDownMethods)
            {
        ...
        {
            KeyCombination keyCombination = new KeyCombination(System.Windows.Input.KeyInterop.KeyFromVirtualKey(keyEventArgs.KeyValue), IsCtrlDown(), IsAltDown(), IsShiftDown());
            foreach (CallbackKeyCombination method in KeyUpMethods)
            {
                method(keyCombination);
            }
        }
