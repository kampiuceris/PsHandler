        ...
        public static PokerType FromXml(string xml)
        {
            try
            {
                ...
                return new PokerType
                {
                    ...
                    BuyInAndRake = root.Element("BuyInAndRake").Elements().Select(o => o.Value).ToArray()
                };
            }
            catch (Exception)
            {
        ...
        public static PokerType FromXElement(XElement xElement)
        {
            try
            {
                return new PokerType
                {
                    ...
                    LevelLengthInSeconds = int.Parse(xElement.Element("LevelLengthInSeconds").Value),
                    ...
                    BuyInAndRake = xElement.Element("BuyInAndRake").Elements().Select(o => o.Value).ToArray()
                };
            }
            catch (Exception)
            {
