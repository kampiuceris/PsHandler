...
namespace PsHandler.PokerMath
{
    ...
    public partial class Hand : IComparable
    {
        ...
        public static string DescriptionFromMask(ulong cards)
        {
            ...
            uint handvalue = Eval(cards, numberOfCards);
        ...
        private void UpdateHandMask()
        {
            ...
            handval = Hand.Eval(handmask, cards);
        }
        ...
        public static uint Eval(ulong cards)
        {
            return Eval(cards, BitCount(cards));
        }
        ...
        public static uint Eval(string hand)
        {
            return Eval(Hand.ParseHand(hand));
        }
        ...
        /// </code>
        /// </example>
        public static uint Eval(ulong cards, int numberOfCards)
        {
